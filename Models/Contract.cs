...
namespace SimpleTracker.Web.Models
{
    ...
    public partial class Contract :  IEquatable<Contract>, IValidatableObject
    {
        ...
        public Contract(int id = default(int), int clientId = default(int), string type = default(string), string startDate = default(string), string endDate = default(string), string[]? tech = default(string[]))
        {
            this.Id = id;
