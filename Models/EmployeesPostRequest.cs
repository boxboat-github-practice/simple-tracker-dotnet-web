...
namespace SimpleTracker.Web.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmployeesPostRequest :  IEquatable<EmployeesPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeesPostRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="github">github.</param>
        public EmployeesPostRequest(string name = default(string), string github = default(string))
        {
            this.Name = name;
            this.Github = github;
        }
        ...
        {
            return this.Equals(input as EmployeesPostRequest);
        }

        /// <summary>
        /// Returns true if EmployeesPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeesPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeesPostRequest input)
        {
            if (input == null)
                return false;
